...
- (void)startGame:(id)sender
{
    ...
    TransitionScene *transition = [FadeTransition transitionWithDuration:0.5 scene:scene withColorRGB:0x000000];
...
- (void)helloEvent:(id)sender
{
    ...
    TransitionScene *transition = [FadeTransition transitionWithDuration:0.5 scene:scene withColorRGB:0xffffff];
    [[Director sharedDirector] replaceScene:transition];
}
